...
//первое больше
START_TEST(test_less_or_equal14) {
...
//первое больше
START_TEST(test_less_or_equal15) {
...
//второе больше
START_TEST(test_less_or_equal16) {
  // самое большое положительное
  s21_decimal dec1 = {{0x1, 0x0, 0x0, 0x0}};
  // самое большое положительное
  s21_decimal dec2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0}};
...
//одинаковые
START_TEST(test_less_or_equal17) {
  // самое большое положительное
...
START_TEST(test_less_or_equal18) {
  // самое большое положительное
  s21_decimal dec1 = {{0, 0, 0, 0}};
  // самое большое положительное
  s21_decimal dec2 = {{0, 0, 0, 0}};
...
START_TEST(test_less_or_equal19) {
  // самое большое положительное
  s21_decimal dec1 = {{0, 0, 0, 0}};
  // самое большое положительное
  s21_decimal dec2 = {{0, 0, 0, 0}};
...
START_TEST(test_less_or_equal20) {
  // самое большое положительное
...
Suite *suite_s21_is_less_or_equal(void) {
  ...
  tcase_add_test(tc, test_less_or_equal14);
  tcase_add_test(tc, test_less_or_equal15);
  tcase_add_test(tc, test_less_or_equal16);
  tcase_add_test(tc, test_less_or_equal17);
  tcase_add_test(tc, test_less_or_equal18);
  tcase_add_test(tc, test_less_or_equal19);
  tcase_add_test(tc, test_less_or_equal20);
